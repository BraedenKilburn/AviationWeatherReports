<template>
  <footer
    class="d-flex flex-wrap justify-content-center align-items-center pt-md-0"
  >
    <a
    ...
    <ul class="nav col-md-6 justify-content-end">
      ...
      <li class="nav-item">
        <router-link to="./airport" class="nav-link px-2 text-muted"
          >Airports</router-link
        >
      </li>
      <li class="nav-item">
        <router-link to="./metar" class="nav-link px-2 text-muted"
          >METAR</router-link
        >
      </li>
      <li class="nav-item">
        <router-link to="./taf" class="nav-link px-2 text-muted"
          >TAF</router-link
        >
      </li>
    </ul>
